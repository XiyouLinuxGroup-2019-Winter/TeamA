...
void Print_menu()
{
    ...
    printf("\t\t\033[1;36m|\033[0m--------1.添加好友-------\033[1;36m|\033[0m\n");
    printf("\t\t\033[1;36m|\033[0m--------2.删除好友-------\033[1;36m|\033[0m\n");
    printf("\t\t\033[1;36m|\033[0m--------3.私聊好友-------\033[1;36m|\033[0m\n");
    printf("\t\t\033[1;36m|\033[0m--------4.屏蔽好友-------\033[1;36m|\033[0m\n");
    printf("\t\t\033[1;36m|\033[0m------5.解除屏蔽好友-----\033[1;36m|\033[0m\n");
    printf("\t\t\033[1;36m|\033[0m------6.查看好友列表-----\033[1;36m|\033[0m\n");
    printf("\t\t\033[1;36m|\033[0m------7.查看聊天记录-----\033[1;36m|\033[0m\n");

    printf("\t\t\033[1;34m|\033[0m--------9.创建群-------\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m--------10.添加群-------\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m--------11.退群---------\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m--------12.群聊---------\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m--------13.已加群-------\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m--------14.群成员-------\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m-----15.查看聊天记录----\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m------16.解散群-----\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m------17.设置群管理-----\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m------18.踢人-----\033[1;34m|\033[0m\n");
    printf("\t\t\033[1;34m|\033[0m------19.发送文件-----\033[1;34m|\033[0m\n");
